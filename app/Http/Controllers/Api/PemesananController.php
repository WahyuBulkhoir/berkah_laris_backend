...
class PemesananController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = Pemesanan::with(['details.produk', 'user'])->orderBy('created_at', 'desc');
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $orderId = 'ORDER-' . $pemesanan->id_pemesanan;
            ...
            // Simpan Snap Token & Order ID Midtrans
            $pemesanan->update([
    ...
    public function alamatRiwayat()
    {
        ...
        $alamatUnik = Pemesanan::where('user_id', $user->id_user)
            ...
            ->unique(function ($item) {
                // Gabungkan semua field jadi satu string, jadi kalau sama semua, dianggap duplikat
    ...
    public function laporanLabaRugi(Request $request)
    {
        ...
        // Ambil semua pesanan selesai dan paid bulan tersebut
        ...
        // Sort dan ambil 3-5 metode pembayaran paling populer
    ...
    public function downloadLaporan(Request $request)
    {
        ...
        // Jika tipe tidak dikenali (fallback - harusnya tidak pernah terjadi)
